...
pyxres Jack sprites with front/back direction selection, a baked Fuse buddy
sprite with 8-way neutral direction selection and primitive fallback,
fixed-step movement, obstacle sliding, pointer ownership for drag-vs-hold,
a start screen, five explicit SE preview hooks,
