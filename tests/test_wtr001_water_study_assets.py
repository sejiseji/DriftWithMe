...
def test_wtr001_runtime_lite_phase_delta_manifest_and_patches_match_contract() -> None:
    ...
    expected_motion_models = {
        "water_mid_plane_c": "low_frequency_sin_drift",
        "water_surface_plane_c": "elliptic_orbit_plus_weak_sin",
        "water_surface_caustics_plane_c": "small_circular_motion_plus_oblique_helper",
        "water_upper_lightnet_plane_c": "small_reverse_circular_lissajous",
    }
    ...
    assert manifest["phase_asset_source"] == "WTR001_Wave2_5_Motion_Field_Decoupling_v0.1"
    assert manifest["wave"] == "Wave2.5"
    assert manifest["theme"] == "motion_field_decoupling"
